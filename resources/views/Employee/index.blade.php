...
<section class="dashboard-counts no-padding-bottom">
  <div class="container-fluid">
    <div class="row bg-white has-shadow">
      <!-- Item -->
      <div class="card d-sm-none d-none">
            ...
            <div class="col-md-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-md-2 emp-list-pic">
                        <img src="images/fmax.jpg">
                    </div>
                    <div class="col-md-4">
                        <h5 class="t-zero">Hussain Ahmed Falah Manik / <small>112</small></h5>
                        <p class="tb-zero">Assistance Director General</p>
                        <p class="tb-zero">Human Resource Dept.</p>
                        <p class="tb-zero">Email: hussain@domain.com</p>
                        <p class="tb-zero">Personal Email: hidden</p>
                    </div>
                    <div class="col-md-3">
                        <p class="tb-zero">Office: +960 7774546, ext. 132</p>
                        <p class="tb-zero">Home: +960 3324394</p>
                        <p class="tb-zero">Mob: +960 9994999</p>
                        <p class="tb-zero">Facebook: hidden</p>
                        <p class="tb-zero">twitter: hidden</p>
                    </div>
                    <div class="col-md-3">
                        <p class="tb-zero">In Office: Yes,</p>
                        <p class="tb-zero">Supervisor for: 10 Staff</p>
                        <p class="tb-zero">Year of Service: 5</p>
                    </div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h5 class="">Hussain Ahmed Falah Manik / <small>112</small></h5>
                        <p class="tb-zero">Assistance Director General</p>
                        <p class="tb-zero">Human Resource Dept.</p>
                        <p class="tb-zero">Email: hussain@domain.com</p>
                        <p class="tb-zero">Personal Email: hidden</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <p class="">Office: +960 7774546, ext. 132</p>
                        <p class="tb-zero">Home: +960 3324394</p>
                        <p class="tb-zero">Mob: +960 9994999</p>
                        <p class="tb-zero">Facebook: hidden</p>
                        <p class="tb-zero">twitter: hidden</p>
